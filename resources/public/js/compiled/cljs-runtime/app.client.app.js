...
app.client.app.sample_results = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"career-matches","career-matches",-1953036919),new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Sports Marketing Manager",new cljs.core.Keyword(null,"category","category",-593092832),"Sports Industry"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Athletic Director",new cljs.core.Keyword(null,"category","category",-593092832),"Sports Industry"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Corporate Sales Executive",new cljs.core.Keyword(null,"category","category",-593092832),"Business & Sales"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Sports Agent",new cljs.core.Keyword(null,"category","category",-593092832),"Sports Industry"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Brand Manager",new cljs.core.Keyword(null,"category","category",-593092832),"Business & Sales"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Public Relations Director",new cljs.core.Keyword(null,"category","category",-593092832),"Media & Communications"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Executive Recruiter",new cljs.core.Keyword(null,"category","category",-593092832),"Business & Sales"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Sports Broadcaster/Analyst",new cljs.core.Keyword(null,"category","category",-593092832),"Sports Industry"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Hotel General Manager",new cljs.core.Keyword(null,"category","category",-593092832),"Hospitality & Tourism"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"Political Campaign Manager",new cljs.core.Keyword(null,"category","category",-593092832),"Law & Public Policy"], null)], null),new cljs.core.Keyword(null,"recommended-majors","recommended-majors",964081293),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Sports Management","Business Administration","Marketing"], null),new cljs.core.Keyword(null,"internship","internship",-692945875),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"recommended","recommended",992487577),true,new cljs.core.Keyword(null,"confidence","confidence",-2080269669),(85)], null),new cljs.core.Keyword(null,"grad-school","grad-school",-591199518),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"recommended","recommended",992487577),true,new cljs.core.Keyword(null,"timing","timing",-1849225195),"After 2-3 years work experience"], null)], null);
/**
 * 
 */
...
var map__58509 = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
var map__58509__$1 = cljs.core.__destructure_map(map__58509);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58509__$1,new cljs.core.Keyword(null,"page","page",849072397));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$client$app$action(p__58510){
var map__58511 = p__58510;
var map__58511__$1 = cljs.core.__destructure_map(map__58511);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58511__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__58512_58591 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58513_58592 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58513_58592);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58512_58591);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58514 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58515 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58515);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58514);
}})], null);
}));
/**
 * 
...
var map__58516 = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
var map__58516__$1 = cljs.core.__destructure_map(map__58516);
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58516__$1,new cljs.core.Keyword(null,"index","index",-1531685915));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$client$app$action(p__58517){
var map__58518 = p__58517;
var map__58518__$1 = cljs.core.__destructure_map(map__58518);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58518__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__58519_58593 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58520_58594 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58520_58594);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58519_58593);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58521 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58522 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58522);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58521);
}})], null);
}));
/**
 * 
...
var map__58523 = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
var map__58523__$1 = cljs.core.__destructure_map(map__58523);
var question_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58523__$1,new cljs.core.Keyword(null,"question-id","question-id",529146980));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58523__$1,new cljs.core.Keyword(null,"value","value",305978217));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$client$app$action(p__58524){
var map__58525 = p__58524;
var map__58525__$1 = cljs.core.__destructure_map(map__58525);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58525__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__58526_58595 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58527_58596 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58527_58596);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58526_58595);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58528 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58529 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58529);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58528);
}})], null);
}));
/**
...
return cljs.core.vec((function (){var iter__5523__auto__ = (function app$client$app$__GT_scoring_responses_$_iter__58532(s__58533){
return (new cljs.core.LazySeq(null,(function (){
var s__58533__$1 = s__58533;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__58533__$1);
if(temp__5804__auto__){
var s__58533__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58533__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__58533__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__58535 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__58534 = (0);
while(true){
if((i__58534 < size__5522__auto__)){
var vec__58536 = cljs.core._nth(c__5521__auto__,i__58534);
var qid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58536,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58536,(1),null);
if((!((value == null)))){
cljs.core.chunk_append(b__58535,(function (){var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(q_map,qid);
var q_type = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(q);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"question-id","question-id",529146980),qid,new cljs.core.Keyword(null,"response-value","response-value",-1642517084),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(q_type,"likert"))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),value], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(q_type,"multiple_choice"))?(function (){var opt = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (i__58534,s__58533__$1,q,q_type,vec__58536,qid,value,c__5521__auto__,size__5522__auto__,b__58535,s__58533__$2,temp__5804__auto__,q_map){
return (function (p1__58530_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__58530_SHARP_),value);
});})(i__58534,s__58533__$1,q,q_type,vec__58536,qid,value,c__5521__auto__,size__5522__auto__,b__58535,s__58533__$2,temp__5804__auto__,q_map))
,new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(q)));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),value,new cljs.core.Keyword(null,"score","score",-1963588780),(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"score","score",-1963588780).cljs$core$IFn$_invoke$arity$1(opt);
...
var opt = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (i__58534,s__58533__$1,selected_val,q,q_type,vec__58536,qid,value,c__5521__auto__,size__5522__auto__,b__58535,s__58533__$2,temp__5804__auto__,q_map){
return (function (p1__58531_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__58531_SHARP_),selected_val);
});})(i__58534,s__58533__$1,selected_val,q,q_type,vec__58536,qid,value,c__5521__auto__,size__5522__auto__,b__58535,s__58533__$2,temp__5804__auto__,q_map))
,new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(q)));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"selected","selected",574897764),selected_val,new cljs.core.Keyword(null,"score","score",-1963588780),(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"score","score",-1963588780).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return 0.5;
...
var G__58597 = (i__58534 + (1));
i__58534 = G__58597;
continue;
} else {
var G__58598 = (i__58534 + (1));
i__58534 = G__58598;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58535),app$client$app$__GT_scoring_responses_$_iter__58532(cljs.core.chunk_rest(s__58533__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58535),null);
}
} else {
var vec__58539 = cljs.core.first(s__58533__$2);
var qid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58539,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58539,(1),null);
if((!((value == null)))){
return cljs.core.cons((function (){var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(q_map,qid);
var q_type = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(q);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"question-id","question-id",529146980),qid,new cljs.core.Keyword(null,"response-value","response-value",-1642517084),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(q_type,"likert"))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),value], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(q_type,"multiple_choice"))?(function (){var opt = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (s__58533__$1,q,q_type,vec__58539,qid,value,s__58533__$2,temp__5804__auto__,q_map){
return (function (p1__58530_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__58530_SHARP_),value);
});})(s__58533__$1,q,q_type,vec__58539,qid,value,s__58533__$2,temp__5804__auto__,q_map))
,new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(q)));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),value,new cljs.core.Keyword(null,"score","score",-1963588780),(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"score","score",-1963588780).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var opt = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (s__58533__$1,selected_val,q,q_type,vec__58539,qid,value,s__58533__$2,temp__5804__auto__,q_map){
return (function (p1__58531_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__58531_SHARP_),selected_val);
});})(s__58533__$1,selected_val,q,q_type,vec__58539,qid,value,s__58533__$2,temp__5804__auto__,q_map))
,new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(q)));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"selected","selected",574897764),selected_val,new cljs.core.Keyword(null,"score","score",-1963588780),(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"score","score",-1963588780).cljs$core$IFn$_invoke$arity$1(opt);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
})(),app$client$app$__GT_scoring_responses_$_iter__58532(cljs.core.rest(s__58533__$2)));
} else {
var G__58599 = cljs.core.rest(s__58533__$2);
s__58533__$1 = G__58599;
continue;
}
}
} else {
...
return iter__5523__auto__(answers);
})());
});
/**
 * 
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$client$app$action(p__58542){
var map__58543 = p__58542;
var map__58543__$1 = cljs.core.__destructure_map(map__58543);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58543__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__58544_58600 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58545_58601 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58545_58601);

try{var answers_58602 = new cljs.core.Keyword(null,"answers","answers",-2066449770).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state));
var responses_58603 = app.client.app.__GT_scoring_responses(answers_58602,app.client.app.sample_questions);
var questions_58604 = app.client.app.__GT_scoring_questions(app.client.app.sample_questions);
var results_58605 = app.scoring.calculate_results(responses_58603,questions_58604,app.careers.careers,cljs.core.PersistentVector.EMPTY);
var personalized_advice_58606 = app.advice.generate_personalized_advice(results_58605,app.careers.careers);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.assoc,new cljs.core.Keyword(null,"computed-results","computed-results",463679020),results_58605,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"personalized-advice","personalized-advice",-2025699737),personalized_advice_58606], 0));
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58544_58600);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__58546 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__58547 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__58547);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__58546);
}})], null);
}));

var options__46170__auto___58607 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_LikertScale(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58548 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58548__$1 = cljs.core.__destructure_map(map__58548);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58548__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58548__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "likert-scale"}),com.fulcrologic.fulcro.components.force_children(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__58549){
var map__58550 = p__58549;
var map__58550__$1 = cljs.core.__destructure_map(map__58550);
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58550__$1,new cljs.core.Keyword(null,"v","v",21465059));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58550__$1,new cljs.core.Keyword(null,"label","label",1718410804));
 ...
 * @constructor
 */
app.client.app.LikertScale = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58607,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.LikertScale,new cljs.core.Keyword("app.client.app","LikertScale","app.client.app/LikertScale",847276388),options__46170__auto___58607);
...
var options__46170__auto___58608 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_MultipleChoice(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58551 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58551__$1 = cljs.core.__destructure_map(map__58551);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword(null,"options","options",99638489));
var selected_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword(null,"selected-value","selected-value",-81904500));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "multiple-choice"}),com.fulcrologic.fulcro.components.force_children(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__58552){
var map__58553 = p__58552;
var map__58553__$1 = cljs.core.__destructure_map(map__58553);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58553__$1,new cljs.core.Keyword(null,"value","value",305978217));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58553__$1,new cljs.core.Keyword(null,"label","label",1718410804));
 ...
 * @constructor
 */
app.client.app.MultipleChoice = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58608,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.MultipleChoice,new cljs.core.Keyword("app.client.app","MultipleChoice","app.client.app/MultipleChoice",288905365),options__46170__auto___58608);
...
var options__46170__auto___58609 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_ScenarioChoice(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58554 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58554__$1 = cljs.core.__destructure_map(map__58554);
var scenario = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58554__$1,new cljs.core.Keyword(null,"scenario","scenario",-316635333));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58554__$1,new cljs.core.Keyword(null,"options","options",99638489));
var selected_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58554__$1,new cljs.core.Keyword(null,"selected-value","selected-value",-81904500));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58554__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"backgroundColor": "#f8fafc", "padding": "20px", "borderRadius": "8px", "marginBottom": "24px", "borderLeft": "4px solid #2563eb"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h4",({"style": ({"marginBottom": "8px", "color": "#1e293b"})}),"Scenario"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["p",({"style": ({"lineHeight": "1.7"})}),com.fulcrologic.fulcro.components.force_children(scenario)]))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h4",({"style": ({"marginBottom": "16px"})}),"How would you respond?"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "multiple-choice"}),com.fulcrologic.fulcro.components.force_children(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__58555){
var map__58556 = p__58555;
var map__58556__$1 = cljs.core.__destructure_map(map__58556);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58556__$1,new cljs.core.Keyword(null,"value","value",305978217));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58556__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var score = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58556__$1,new cljs.core.Keyword(null,"score","score",-1963588780));
return com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("div",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),value,new cljs.core.Keyword(null,"className","className",-1983287057),["choice-option ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selected_value,value))?"selected":null)].join(''),new cljs.core.Keyword(null,"onClick","onClick",-1991238530),(function (){
var G__58557 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),value,new cljs.core.Keyword(null,"score","score",-1963588780),score], null);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__58557) : on_change.call(null,G__58557));
})], null),label], null),null);
}),options))]))]);
}));
})], null);
 ...
 * @constructor
 */
app.client.app.ScenarioChoice = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58609,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.ScenarioChoice,new cljs.core.Keyword("app.client.app","ScenarioChoice","app.client.app/ScenarioChoice",163790801),options__46170__auto___58609);
...
var options__46170__auto___58610 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_RankingChoice(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58558 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58558__$1 = cljs.core.__destructure_map(map__58558);
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword(null,"options","options",99638489));
var current_ranks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword(null,"current-ranks","current-ranks",-996608182));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58558__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var G__58559 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ranks","ranks",-1802584866),cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([item]),current_ranks))], null);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__58559) : on_change.call(null,G__58559));
...
var G__58560 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ranks","ranks",-1802584866),cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = current_ranks;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__58560) : on_change.call(null,G__58560));
})], null),item], null),null);
}),available))]):null))]);
}));
})], null);
 ...
 * @constructor
 */
app.client.app.RankingChoice = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58610,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.RankingChoice,new cljs.core.Keyword("app.client.app","RankingChoice","app.client.app/RankingChoice",2011036960),options__46170__auto___58610);
...
var options__46170__auto___58611 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_Question(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58561 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58561__$1 = cljs.core.__destructure_map(map__58561);
var question = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58561__$1,new cljs.core.Keyword(null,"question","question",-1411720117));
var answer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58561__$1,new cljs.core.Keyword(null,"answer","answer",-742633163));
var on_answer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58561__$1,new cljs.core.Keyword(null,"on-answer","on-answer",2133327845));
var map__58562 = question;
var map__58562__$1 = cljs.core.__destructure_map(map__58562);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58562__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58562__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58562__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58562__$1,new cljs.core.Keyword(null,"options","options",99638489));
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "card"}),com.fulcrologic.fulcro.components.force_children(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(type,"scenario"))?null:com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h3",({"style": ({"marginBottom": "24px"})}),com.fulcrologic.fulcro.components.force_children(text)]))),com.fulcrologic.fulcro.components.force_children((function (){var G__58563 = type;
switch (G__58563) {
case "likert":
var G__58564 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),answer,new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_answer], null);
return (app.client.app.ui_likert_scale.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_likert_scale.cljs$core$IFn$_invoke$arity$1(G__58564) : app.client.app.ui_likert_scale.call(null,G__58564));

break;
case "multiple_choice":
var G__58565 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"options","options",99638489),options,new cljs.core.Keyword(null,"selected-value","selected-value",-81904500),answer,new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_answer], null);
return (app.client.app.ui_multiple_choice.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_multiple_choice.cljs$core$IFn$_invoke$arity$1(G__58565) : app.client.app.ui_multiple_choice.call(null,G__58565));

break;
case "scenario":
var G__58566 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"scenario","scenario",-316635333),text,new cljs.core.Keyword(null,"options","options",99638489),options,new cljs.core.Keyword(null,"selected-value","selected-value",-81904500),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(answer),new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_answer], null);
return (app.client.app.ui_scenario_choice.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_scenario_choice.cljs$core$IFn$_invoke$arity$1(G__58566) : app.client.app.ui_scenario_choice.call(null,G__58566));

break;
case "ranking":
var G__58567 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"options","options",99638489),options,new cljs.core.Keyword(null,"current-ranks","current-ranks",-996608182),new cljs.core.Keyword(null,"ranks","ranks",-1802584866).cljs$core$IFn$_invoke$arity$1(answer),new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_answer], null);
return (app.client.app.ui_ranking_choice.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_ranking_choice.cljs$core$IFn$_invoke$arity$1(G__58567) : app.client.app.ui_ranking_choice.call(null,G__58567));

break;
default:
var G__58568 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),answer,new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_answer], null);
return (app.client.app.ui_likert_scale.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_likert_scale.cljs$core$IFn$_invoke$arity$1(G__58568) : app.client.app.ui_likert_scale.call(null,G__58568));
 ...
 * @constructor
 */
app.client.app.Question = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58611,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.Question,new cljs.core.Keyword("app.client.app","Question","app.client.app/Question",-1037883579),options__46170__auto___58611);
...
var options__46170__auto___58613 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_LandingPage(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58569 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58569__$1 = cljs.core.__destructure_map(map__58569);
var on_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58569__$1,new cljs.core.Keyword(null,"on-start","on-start",-1839785985));
 ...
 * @constructor
 */
app.client.app.LandingPage = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58613,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.LandingPage,new cljs.core.Keyword("app.client.app","LandingPage","app.client.app/LandingPage",504073193),options__46170__auto___58613);
...
var options__46170__auto___58615 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_QuestionnairePage(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58571 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58571__$1 = cljs.core.__destructure_map(map__58571);
var question_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"question-index","question-index",1682907848));
var answers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"answers","answers",-2066449770));
var on_answer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"on-answer","on-answer",2133327845));
var on_next = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"on-next","on-next",1556687516));
var on_back = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"on-back","on-back",1678532171));
var on_complete = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58571__$1,new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971));
 ...
 * @constructor
 */
app.client.app.QuestionnairePage = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58615,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.QuestionnairePage,new cljs.core.Keyword("app.client.app","QuestionnairePage","app.client.app/QuestionnairePage",-416199236),options__46170__auto___58615);
...
var options__46170__auto___58616 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$client$app$render_ResultsPage(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58573 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58573__$1 = cljs.core.__destructure_map(map__58573);
var computed_results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58573__$1,new cljs.core.Keyword(null,"computed-results","computed-results",463679020));
var personalized_advice = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58573__$1,new cljs.core.Keyword(null,"personalized-advice","personalized-advice",-2025699737));
var on_restart = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58573__$1,new cljs.core.Keyword(null,"on-restart","on-restart",-83802489));
var map__58574 = computed_results;
var map__58574__$1 = cljs.core.__destructure_map(map__58574);
var career_scores = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58574__$1,new cljs.core.Keyword(null,"career-scores","career-scores",-1890079113));
var recommendations = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58574__$1,new cljs.core.Keyword(null,"recommendations","recommendations",-154139268));
var career_matches = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,c){
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"career-name","career-name",2126938427).cljs$core$IFn$_invoke$arity$1(c),new cljs.core.Keyword(null,"rank","rank",-1706728502),(idx + (1)),new cljs.core.Keyword(null,"category","category",-593092832),new cljs.core.Keyword(null,"career-category","career-category",1896068630).cljs$core$IFn$_invoke$arity$1(c),new cljs.core.Keyword(null,"majors","majors",1778632879),new cljs.core.Keyword(null,"typical-majors","typical-majors",-450837630).cljs$core$IFn$_invoke$arity$1(c)], null);
}),cljs.core.take.cljs$core$IFn$_invoke$arity$2((10),career_scores));
...
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "container"}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "result-card"}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h1",({"style": ({"margin": "0 0 8px 0"})}),"Your Career Profile"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["p",({"style": ({"opacity": "0.9"})}),"Based on your responses, here are your personalized recommendations."]))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "card"}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "accent-stripe"})])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h2",({"style": ({"marginBottom": "24px"})}),"Top 10 Career Matches"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "stagger-in"}),com.fulcrologic.fulcro.components.force_children(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__58575){
var map__58576 = p__58575;
var map__58576__$1 = cljs.core.__destructure_map(map__58576);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var rank = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword(null,"rank","rank",-1706728502));
var category = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword(null,"category","category",-593092832));
var majors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58576__$1,new cljs.core.Keyword(null,"majors","majors",1778632879));
return com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("div",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),name,new cljs.core.Keyword(null,"className","className",-1983287057),"card",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"marginBottom","marginBottom",1236079031),"12px"], null)], null),com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"display": "flex", "alignItems": "center", "gap": "16px"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"color": "#fff", "borderRadius": "12px", "minWidth": "48px", "background": "linear-gradient(135deg, #2563eb, #3b82f6)", "justifyContent": "center", "fontWeight": "900", "display": "flex", "fontSize": "1.25rem", "height": "48px", "alignItems": "center"})}),com.fulcrologic.fulcro.components.force_children(["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(rank)].join(''))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"flex": "1"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h4",({"style": ({"margin": "0 0 4px 0"})}),com.fulcrologic.fulcro.components.force_children(name)])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["span",({"style": ({"color": "#64748b", "fontSize": "0.9rem", "fontWeight": "500"})}),com.fulcrologic.fulcro.components.force_children(category)]))]))]),((cljs.core.seq(majors))?com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"marginTop": "12px", "paddingTop": "12px", "borderTop": "1px solid #e2e8f0"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["span",({"style": ({"fontSize": "0.85rem", "color": "#64748b", "fontWeight": "500"})}),"Related majors: "])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["span",({"style": ({"fontSize": "0.85rem", "fontWeight": "600"})}),com.fulcrologic.fulcro.components.force_children(clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.take.cljs$core$IFn$_invoke$arity$2((3),majors)))]))]):null)], null),null);
 ...
 * @constructor
 */
app.client.app.ResultsPage = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58616,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.ResultsPage,new cljs.core.Keyword("app.client.app","ResultsPage","app.client.app/ResultsPage",1156627771),options__46170__auto___58616);
...
var options__46170__auto___58617 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"query","query",-1288509510),(function app$client$app$query_STAR_(this$){
...
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__58578 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__58578__$1 = cljs.core.__destructure_map(map__58578);
var current_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58578__$1,new cljs.core.Keyword(null,"current-page","current-page",-101294180));
var current_question = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58578__$1,new cljs.core.Keyword(null,"current-question","current-question",-749753188));
var answers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58578__$1,new cljs.core.Keyword(null,"answers","answers",-2066449770));
var computed_results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58578__$1,new cljs.core.Keyword(null,"computed-results","computed-results",463679020));
var personalized_advice = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58578__$1,new cljs.core.Keyword(null,"personalized-advice","personalized-advice",-2025699737));
var G__58579 = current_page;
var G__58579__$1 = (((G__58579 instanceof cljs.core.Keyword))?G__58579.fqn:null);
switch (G__58579__$1) {
case "landing":
var G__58580 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-start","on-start",-1839785985),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58581 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"questionnaire","questionnaire",120538116)], null);
return (app.client.app.set_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_page.cljs$core$IFn$_invoke$arity$1(G__58581) : app.client.app.set_page.call(null,G__58581));
})()], null));
})], null);
return (app.client.app.ui_landing_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_landing_page.cljs$core$IFn$_invoke$arity$1(G__58580) : app.client.app.ui_landing_page.call(null,G__58580));

break;
case "questionnaire":
var G__58582 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"question-index","question-index",1682907848),current_question,new cljs.core.Keyword(null,"answers","answers",-2066449770),answers,new cljs.core.Keyword(null,"on-answer","on-answer",2133327845),(function (p1__58577_SHARP_){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58583 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"question-id","question-id",529146980),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(app.client.app.sample_questions,current_question)),new cljs.core.Keyword(null,"value","value",305978217),p1__58577_SHARP_], null);
return (app.client.app.save_answer.cljs$core$IFn$_invoke$arity$1 ? app.client.app.save_answer.cljs$core$IFn$_invoke$arity$1(G__58583) : app.client.app.save_answer.call(null,G__58583));
})()], null));
}),new cljs.core.Keyword(null,"on-next","on-next",1556687516),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58584 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"index","index",-1531685915),(current_question + (1))], null);
return (app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1(G__58584) : app.client.app.set_question_index.call(null,G__58584));
})()], null));
}),new cljs.core.Keyword(null,"on-back","on-back",1678532171),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58585 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"index","index",-1531685915),(current_question - (1))], null);
return (app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1(G__58585) : app.client.app.set_question_index.call(null,G__58585));
})()], null));
}),new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58586 = cljs.core.PersistentArrayMap.EMPTY;
return (app.client.app.compute_results.cljs$core$IFn$_invoke$arity$1 ? app.client.app.compute_results.cljs$core$IFn$_invoke$arity$1(G__58586) : app.client.app.compute_results.call(null,G__58586));
})(),(function (){var G__58587 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"results","results",-1134170113)], null);
return (app.client.app.set_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_page.cljs$core$IFn$_invoke$arity$1(G__58587) : app.client.app.set_page.call(null,G__58587));
})()], null));
})], null);
return (app.client.app.ui_questionnaire_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_questionnaire_page.cljs$core$IFn$_invoke$arity$1(G__58582) : app.client.app.ui_questionnaire_page.call(null,G__58582));
...
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__58589 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"landing","landing",-1137922265)], null);
return (app.client.app.set_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_page.cljs$core$IFn$_invoke$arity$1(G__58589) : app.client.app.set_page.call(null,G__58589));
})(),(function (){var G__58590 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"index","index",-1531685915),(0)], null);
return (app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1 ? app.client.app.set_question_index.cljs$core$IFn$_invoke$arity$1(G__58590) : app.client.app.set_question_index.call(null,G__58590));
})()], null));
})], null);
return (app.client.app.ui_results_page.cljs$core$IFn$_invoke$arity$1 ? app.client.app.ui_results_page.cljs$core$IFn$_invoke$arity$1(G__58588) : app.client.app.ui_results_page.call(null,G__58588));
 ...
 * @constructor
 */
app.client.app.Root = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__46170__auto___58617,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.client.app.Root,new cljs.core.Keyword("app.client.app","Root","app.client.app/Root",627152149),options__46170__auto___58617);
