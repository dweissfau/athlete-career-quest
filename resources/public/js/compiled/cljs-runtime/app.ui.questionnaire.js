...
var map__28808 = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28809){
var map__28810 = p__28809;
var map__28810__$1 = cljs.core.__destructure_map(map__28810);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28810__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28815_28912 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28816_28913 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28816_28913);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28815_28912);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28817 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28818 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28818);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28817);
}})], null);
}));
/**
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28822){
var map__28823 = p__28822;
var map__28823__$1 = cljs.core.__destructure_map(map__28823);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28823__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28824_28914 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28825_28915 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28825_28915);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28824_28914);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28826 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28827 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28827);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28826);
}})], null);
}));
/**
...
var _ = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28831){
var map__28832 = p__28831;
var map__28832__$1 = cljs.core.__destructure_map(map__28832);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28832__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28833_28916 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28834_28917 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28834_28917);

try{cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551),new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword(null,"current-index","current-index",821935409)], null),cljs.core.dec);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551),new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword(null,"current-response","current-response",-253144463)], null),null);
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28833_28916);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28835 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28836 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28836);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28835);
}})], null);
}));
/**
...
var map__28841 = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
var map__28841__$1 = cljs.core.__destructure_map(map__28841);
var question_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28841__$1,new cljs.core.Keyword(null,"question-id","question-id",529146980));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28841__$1,new cljs.core.Keyword(null,"value","value",305978217));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28842){
var map__28843 = p__28842;
var map__28843__$1 = cljs.core.__destructure_map(map__28843);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28843__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28844_28918 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28845_28919 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28845_28919);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28844_28918);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28848 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28849 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28849);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28848);
}})], null);
}));
/**
...
var _ = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28851){
var map__28852 = p__28851;
var map__28852__$1 = cljs.core.__destructure_map(map__28852);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28852__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28853_28921 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28854_28922 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28854_28922);

try{cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551),new cljs.core.Keyword(null,"main","main",-2117802661)], null),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"current-index","current-index",821935409),(0),new cljs.core.Keyword(null,"current-response","current-response",-253144463),null,new cljs.core.Keyword(null,"responses","responses",1257546453),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"is-complete","is-complete",2054921779),false,new cljs.core.Keyword(null,"show-intro","show-intro",1916476804),true], null));
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28853_28921);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28857 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28858 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28858);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28857);
}})], null);
}));
/**
...
var _ = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28859){
var map__28860 = p__28859;
var map__28860__$1 = cljs.core.__destructure_map(map__28860);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28860__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28861_28924 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28862_28925 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28862_28925);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28861_28924);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28864 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28865 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28865);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28864);
}})], null);
}));
/**
...
var _ = new cljs.core.Keyword(null,"params","params",710516235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ast","ast",-860334068).cljs$core$IFn$_invoke$arity$1(fulcro_mutation_env_symbol));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function app$ui$questionnaire$action(p__28868){
var map__28869 = p__28868;
var map__28869__$1 = cljs.core.__destructure_map(map__28869);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28869__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var _STAR_after_render_STAR__orig_val__28870_28929 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28871_28930 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28871_28930);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28870_28929);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__28872 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__28873 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__28873);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__28872);
}})], null);
}));

var options__20391__auto___28933 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$ui$questionnaire$render_CategoryIntro(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__28874 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__28874__$1 = cljs.core.__destructure_map(map__28874);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28874__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28874__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28874__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var on_continue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28874__$1,new cljs.core.Keyword(null,"on-continue","on-continue",-723719945));
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "card", "style": ({"textAlign": "center", "padding": "48px"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h2",({"style": ({"marginBottom": "16px", "color": "#2563eb"})}),com.fulcrologic.fulcro.components.force_children(display_name)])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["p",({"style": ({"color": "#64748b", "marginBottom": "32px", "maxWidth": "500px", "margin": "0 auto 32px"})}),com.fulcrologic.fulcro.components.force_children(description)])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-primary",new cljs.core.Keyword(null,"onClick","onClick",-1991238530),on_continue], null),"Begin Section"], null),null))]);
}));
})], null);
 ...
 * @constructor
 */
app.ui.questionnaire.CategoryIntro = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__20391__auto___28933,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.ui.questionnaire.CategoryIntro,new cljs.core.Keyword("app.ui.questionnaire","CategoryIntro","app.ui.questionnaire/CategoryIntro",-372049172),options__20391__auto___28933);
...
var options__20391__auto___28938 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"render","render",-1408033454),(function app$ui$questionnaire$render_QuestionNavigation(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__28879 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__28879__$1 = cljs.core.__destructure_map(map__28879);
var current_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"current-index","current-index",821935409));
var total = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"total","total",1916810418));
var can_go_back = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"can-go-back","can-go-back",503206789));
var on_back = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"on-back","on-back",1678532171));
var on_next = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"on-next","on-next",1556687516));
var on_skip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"on-skip","on-skip",700381342));
var has_response = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"has-response","has-response",731527185));
var is_last = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28879__$1,new cljs.core.Keyword(null,"is-last","is-last",-2060069857));
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"display": "flex", "justifyContent": "space-between", "marginTop": "24px"})}),com.fulcrologic.fulcro.components.force_children((cljs.core.truth_(can_go_back)?com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-secondary",new cljs.core.Keyword(null,"onClick","onClick",-1991238530),on_back], null),"Back"], null),null):com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({})]))),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"display": "flex", "gap": "12px"})}),com.fulcrologic.fulcro.components.force_children((cljs.core.truth_(is_last)?null:com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-secondary",new cljs.core.Keyword(null,"onClick","onClick",-1991238530),on_skip], null),"Skip"], null),null))),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-primary",new cljs.core.Keyword(null,"onClick","onClick",-1991238530),on_next,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(function (){var and__5000__auto__ = cljs.core.not(has_response);
 ...
 * @constructor
 */
app.ui.questionnaire.QuestionNavigation = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__20391__auto___28938,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.ui.questionnaire.QuestionNavigation,new cljs.core.Keyword("app.ui.questionnaire","QuestionNavigation","app.ui.questionnaire/QuestionNavigation",-1750559443),options__20391__auto___28938);
...
var options__20391__auto___28942 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"query","query",-1288509510),(function app$ui$questionnaire$query_STAR_(this$){
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551),new cljs.core.Keyword("questionnaire","current-index","questionnaire/current-index",-56700780),new cljs.core.Keyword("questionnaire","current-response","questionnaire/current-response",-1354217344),new cljs.core.Keyword("questionnaire","responses","questionnaire/responses",-1919657558),new cljs.core.Keyword("questionnaire","is-complete","questionnaire/is-complete",538880984),new cljs.core.Keyword("questionnaire","show-intro","questionnaire/show-intro",-1227346073),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("questionnaire","questions","questionnaire/questions",-1934394707),com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(app.ui.questions.Question)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("questionnaire","categories","questionnaire/categories",-939465643),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("category","id","category/id",-1505923754),new cljs.core.Keyword("category","name","category/name",1793490219),new cljs.core.Keyword("category","display-name","category/display-name",643312825),new cljs.core.Keyword("category","description","category/description",-1613225378)], null)], null)], null);
...
return new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551),new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword("questionnaire","current-index","questionnaire/current-index",-56700780),(0),new cljs.core.Keyword("questionnaire","current-response","questionnaire/current-response",-1354217344),null,new cljs.core.Keyword("questionnaire","responses","questionnaire/responses",-1919657558),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword("questionnaire","is-complete","questionnaire/is-complete",538880984),false,new cljs.core.Keyword("questionnaire","show-intro","questionnaire/show-intro",-1227346073),true,new cljs.core.Keyword("questionnaire","questions","questionnaire/questions",-1934394707),(app.ui.questionnaire.get_sample_questions.cljs$core$IFn$_invoke$arity$0 ? app.ui.questionnaire.get_sample_questions.cljs$core$IFn$_invoke$arity$0() : app.ui.questionnaire.get_sample_questions.call(null)),new cljs.core.Keyword("questionnaire","categories","questionnaire/categories",-939465643),(app.ui.questionnaire.get_sample_categories.cljs$core$IFn$_invoke$arity$0 ? app.ui.questionnaire.get_sample_categories.cljs$core$IFn$_invoke$arity$0() : app.ui.questionnaire.get_sample_categories.call(null))], null);
}),new cljs.core.Keyword(null,"render","render",-1408033454),(function app$ui$questionnaire$render_Questionnaire(this$){
return com.fulcrologic.fulcro.components.wrapped_render(this$,(function (){
var map__28891 = (com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.components.props.cljs$core$IFn$_invoke$arity$1(this$) : com.fulcrologic.fulcro.components.props.call(null,this$));
var map__28891__$1 = cljs.core.__destructure_map(map__28891);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","id","questionnaire/id",-417481551));
var current_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","current-index","questionnaire/current-index",-56700780));
var current_response = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","current-response","questionnaire/current-response",-1354217344));
var responses = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","responses","questionnaire/responses",-1919657558));
var is_complete = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","is-complete","questionnaire/is-complete",538880984));
var show_intro = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","show-intro","questionnaire/show-intro",-1227346073));
var questions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","questions","questionnaire/questions",-1934394707));
var categories = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword("questionnaire","categories","questionnaire/categories",-939465643));
...
var response_value = (function (){var or__5002__auto__ = current_response;
...
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "container"}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "card", "style": ({"textAlign": "center", "padding": "48px"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h1",({"style": ({"fontSize": "2rem", "marginBottom": "16px"})}),"Career Path Assessment"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["p",({"style": ({"color": "#64748b", "marginBottom": "24px", "maxWidth": "500px", "margin": "0 auto 24px"})}),"This questionnaire will help you discover career paths that align with your interests,\n             skills, and goals. Answer honestly - there are no right or wrong answers."])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"display": "flex", "justifyContent": "center", "gap": "24px", "marginBottom": "32px"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"textAlign": "center"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"fontSize": "2rem", "fontWeight": "bold", "color": "#2563eb"})}),com.fulcrologic.fulcro.components.force_children(total_questions)])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"color": "#64748b"})}),"Questions"]))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"textAlign": "center"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"fontSize": "2rem", "fontWeight": "bold", "color": "#2563eb"})}),"~15"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"color": "#64748b"})}),"Minutes"]))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"textAlign": "center"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"fontSize": "2rem", "fontWeight": "bold", "color": "#2563eb"})}),"4"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"color": "#64748b"})}),"Recommendations"]))]))])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-primary",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fontSize","fontSize",919623033),"1.1rem",new cljs.core.Keyword(null,"padding","padding",1660304693),"16px 48px"], null),new cljs.core.Keyword(null,"onClick","onClick",-1991238530),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28893 = cljs.core.PersistentArrayMap.EMPTY;
return (app.ui.questionnaire.hide_intro.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.hide_intro.cljs$core$IFn$_invoke$arity$1(G__28893) : app.ui.questionnaire.hide_intro.call(null,G__28893));
})()], null));
})], null),"Start Assessment"], null),null))]))]);
} else {
if(cljs.core.truth_(is_complete)){
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "container"}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "card", "style": ({"textAlign": "center", "padding": "48px"})}),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"style": ({"fontSize": "4rem", "marginBottom": "16px"})}),"\u2713"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["h2",({"style": ({"marginBottom": "16px"})}),"Assessment Complete!"])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["p",({"style": ({"color": "#64748b", "marginBottom": "24px"})}),"Your personalized career recommendations are ready."])),com.fulcrologic.fulcro.components.force_children(com.fulcrologic.fulcro.dom.macro_create_element.cljs$core$IFn$_invoke$arity$3("button",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"className","className",-1983287057),"btn btn-primary",new cljs.core.Keyword(null,"onClick","onClick",-1991238530),(function (){
...
return com.fulcrologic.fulcro.dom.macro_create_element_STAR_(["div",({"className": "container"}),com.fulcrologic.fulcro.components.force_children((function (){var G__28894 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current","current",-1088038603),(current_index + (1)),new cljs.core.Keyword(null,"total","total",1916810418),total_questions], null);
return (app.ui.components.ui_progress_bar.cljs$core$IFn$_invoke$arity$1 ? app.ui.components.ui_progress_bar.cljs$core$IFn$_invoke$arity$1(G__28894) : app.ui.components.ui_progress_bar.call(null,G__28894));
})()),com.fulcrologic.fulcro.components.force_children((function (){var G__28896 = (function (){var G__28897 = current_question;
var G__28898 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),response_value,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (value){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28899 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),value], null);
return (app.ui.questionnaire.set_current_response.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.set_current_response.cljs$core$IFn$_invoke$arity$1(G__28899) : app.ui.questionnaire.set_current_response.call(null,G__28899));
})()], null));
})], null);
return (com.fulcrologic.fulcro.components.computed.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.components.computed.cljs$core$IFn$_invoke$arity$2(G__28897,G__28898) : com.fulcrologic.fulcro.components.computed.call(null,G__28897,G__28898));
})();
return (app.ui.questions.ui_question.cljs$core$IFn$_invoke$arity$1 ? app.ui.questions.ui_question.cljs$core$IFn$_invoke$arity$1(G__28896) : app.ui.questions.ui_question.call(null,G__28896));
})()),com.fulcrologic.fulcro.components.force_children((function (){var G__28900 = new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"current-index","current-index",821935409),current_index,new cljs.core.Keyword(null,"total","total",1916810418),total_questions,new cljs.core.Keyword(null,"can-go-back","can-go-back",503206789),(current_index > (0)),new cljs.core.Keyword(null,"has-response","has-response",731527185),has_response,new cljs.core.Keyword(null,"is-last","is-last",-2060069857),is_last,new cljs.core.Keyword(null,"on-back","on-back",1678532171),(function (){
if(has_response){
com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28901 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"question-id","question-id",529146980),current_question_id,new cljs.core.Keyword(null,"value","value",305978217),response_value], null);
return (app.ui.questionnaire.save_response.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.save_response.cljs$core$IFn$_invoke$arity$1(G__28901) : app.ui.questionnaire.save_response.call(null,G__28901));
})()], null));
} else {
}

return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28902 = cljs.core.PersistentArrayMap.EMPTY;
return (app.ui.questionnaire.previous_question.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.previous_question.cljs$core$IFn$_invoke$arity$1(G__28902) : app.ui.questionnaire.previous_question.call(null,G__28902));
})()], null));
}),new cljs.core.Keyword(null,"on-next","on-next",1556687516),(function (){
if(has_response){
com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28903 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"question-id","question-id",529146980),current_question_id,new cljs.core.Keyword(null,"value","value",305978217),response_value], null);
return (app.ui.questionnaire.save_response.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.save_response.cljs$core$IFn$_invoke$arity$1(G__28903) : app.ui.questionnaire.save_response.call(null,G__28903));
})()], null));
} else {
}

if(is_last){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28904 = cljs.core.PersistentArrayMap.EMPTY;
return (app.ui.questionnaire.complete_questionnaire.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.complete_questionnaire.cljs$core$IFn$_invoke$arity$1(G__28904) : app.ui.questionnaire.complete_questionnaire.call(null,G__28904));
})()], null));
} else {
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28905 = cljs.core.PersistentArrayMap.EMPTY;
return (app.ui.questionnaire.next_question.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.next_question.cljs$core$IFn$_invoke$arity$1(G__28905) : app.ui.questionnaire.next_question.call(null,G__28905));
})()], null));
}
}),new cljs.core.Keyword(null,"on-skip","on-skip",700381342),(function (){
return com.fulcrologic.fulcro.components.transact_BANG_.cljs$core$IFn$_invoke$arity$2(this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__28906 = cljs.core.PersistentArrayMap.EMPTY;
return (app.ui.questionnaire.next_question.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.next_question.cljs$core$IFn$_invoke$arity$1(G__28906) : app.ui.questionnaire.next_question.call(null,G__28906));
})()], null));
})], null);
return (app.ui.questionnaire.ui_question_navigation.cljs$core$IFn$_invoke$arity$1 ? app.ui.questionnaire.ui_question_navigation.cljs$core$IFn$_invoke$arity$1(G__28900) : app.ui.questionnaire.ui_question_navigation.call(null,G__28900));
})())]);
 ...
 * @constructor
 */
app.ui.questionnaire.Questionnaire = com.fulcrologic.fulcro.components.react_constructor(cljs.core.get.cljs$core$IFn$_invoke$arity$2(options__20391__auto___28942,new cljs.core.Keyword(null,"initLocalState","initLocalState",-46503876)));
}

com.fulcrologic.fulcro.components.configure_component_BANG_(app.ui.questionnaire.Questionnaire,new cljs.core.Keyword("app.ui.questionnaire","Questionnaire","app.ui.questionnaire/Questionnaire",-133083802),options__20391__auto___28942);
