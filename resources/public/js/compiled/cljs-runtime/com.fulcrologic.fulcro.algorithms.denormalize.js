 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__44222){
var vec__44224 = p__44222;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44224,(0),null);
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__44230){
var vec__44231 = p__44230;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44231,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44231,(1),null);
var ref = vec__44231;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__44238){
var map__44239 = p__44238;
var map__44239__$1 = cljs.core.__destructure_map(map__44239);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44239__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__44241,entity,state_map,parent_node,idents_seen){
var map__44242 = p__44241;
var map__44242__$1 = cljs.core.__destructure_map(map__44242);
var join_node = map__44242__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44242__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44242__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__44259,entity,state_map,idents_seen){
var map__44260 = p__44259;
var map__44260__$1 = cljs.core.__destructure_map(map__44260);
var join_node = map__44260__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44260__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__44261){
var map__44263 = p__44261;
var map__44263__$1 = cljs.core.__destructure_map(map__44263);
var node = map__44263__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44263__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__44266 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44266,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__44269 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__44269) : union_key__GT_query.call(null,G__44269));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__44272,current_entity,state_map,idents_seen){
var map__44273 = p__44272;
var map__44273__$1 = cljs.core.__destructure_map(map__44273);
var top_node = map__44273__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44273__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44273__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__44275 = nil_nodes;
var G__44275__$1 = (((G__44275 == null))?null:cljs.core.first(G__44275));
if((G__44275__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__44275__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__44276 = result_node__$1;
var G__44276__$1 = (((G__44276 == null))?null:cljs.core.persistent_BANG_(G__44276));
if((G__44276__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__44276__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__44277 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__44278 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__44278);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__44280 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__44280 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__44280,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__44277);
}});
/**
...
var G__44281 = props;
var G__44281__$1 = (((G__44281 == null))?null:cljs.core.meta(G__44281));
if((G__44281__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__44281__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__44286 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__44287 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__44287);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__44286);
}});
/**
...
var map__44290 = cljs.core.meta(prior_props);
var map__44290__$1 = cljs.core.__destructure_map(map__44290);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44290__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44290__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
