 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__21449){
var vec__21450 = p__21449;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21450,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21450,(1),null);
var ref = vec__21450;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__21456){
var vec__21457 = p__21456;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21457,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21457,(1),null);
var ref = vec__21457;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__21461){
var map__21462 = p__21461;
var map__21462__$1 = cljs.core.__destructure_map(map__21462);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21462__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5802__auto__ = (function (){var and__5000__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__21467,entity,state_map,parent_node,idents_seen){
var map__21468 = p__21467;
var map__21468__$1 = cljs.core.__destructure_map(map__21468);
var join_node = map__21468__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21468__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21468__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
if(cljs.core.truth_((function (){var and__5000__auto__ = recursive_QMARK_;
if(and__5000__auto__){
return join_entity;
} else {
return and__5000__auto__;
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__21484,entity,state_map,idents_seen){
var map__21485 = p__21484;
var map__21485__$1 = cljs.core.__destructure_map(map__21485);
var join_node = map__21485__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21485__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__21486){
var map__21487 = p__21486;
var map__21487__$1 = cljs.core.__destructure_map(map__21487);
var node = map__21487__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21487__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5802__auto__ = (function (){var and__5000__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__5000__auto__){
...
var vec__21490 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21490,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__21494 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__21494) : union_key__GT_query.call(null,G__21494));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__21500,current_entity,state_map,idents_seen){
var map__21501 = p__21500;
var map__21501__$1 = cljs.core.__destructure_map(map__21501);
var top_node = map__21501__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21501__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21501__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var wildcard_QMARK_ = (function (){var and__5000__auto__ = nil_nodes;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__21502 = nil_nodes;
var G__21502__$1 = (((G__21502 == null))?null:cljs.core.first(G__21502));
if((G__21502__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__21502__$1);
}
})());
} else {
return and__5000__auto__;
...
var G__21504 = result_node__$1;
var G__21504__$1 = (((G__21504 == null))?null:cljs.core.persistent_BANG_(G__21504));
if((G__21504__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__21504__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__21507 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__21508 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__21508);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__21510 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__21510 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__21510,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__21507);
}});
/**
...
var G__21515 = props;
var G__21515__$1 = (((G__21515 == null))?null:cljs.core.meta(G__21515));
if((G__21515__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__21515__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__21517 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__21518 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__21518);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__21517);
}});
/**
...
var map__21524 = cljs.core.meta(prior_props);
var map__21524__$1 = cljs.core.__destructure_map(map__21524);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21524__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21524__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
