...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__25722){
var map__25723 = p__25722;
var map__25723__$1 = cljs.core.__destructure_map(map__25723);
var ast = map__25723__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25723__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25723__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__25724){
var map__25725 = p__25724;
var map__25725__$1 = cljs.core.__destructure_map(map__25725);
var child_ast = map__25725__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25725__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25725__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25725__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__25727 = idx;
var G__25727__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__25727,dispatch_key,parent_key):G__25727);
var G__25727__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__25727__$1,key,parent_key):G__25727__$1);
var G__25727__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__25727__$2,key,parent_key):G__25727__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__25727__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__25727__$3,child_ast));
} else {
return G__25727__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25732__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__25734){
var map__25735 = p__25734;
var map__25735__$1 = cljs.core.__destructure_map(map__25735);
var ast = map__25735__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25735__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25735__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-1418828349);

var map__25740 = app__$1;
var map__25740__$1 = cljs.core.__destructure_map(map__25740);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25740__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25740__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__25745 = cljs.core.deref(runtime_atom);
var map__25745__$1 = cljs.core.__destructure_map(map__25745);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25745__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__25751 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__25751__$1 = cljs.core.__destructure_map(map__25751);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25751__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
if(cljs.core.truth_((function (){var and__5000__auto__ = ident;
...
var map__25766 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__25766__$1 = cljs.core.__destructure_map(map__25766);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25766__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__25786){
var map__25787 = p__25786;
var map__25787__$1 = cljs.core.__destructure_map(map__25787);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25787__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__25793_25829 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__25794_25830 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__25794_25830);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__25793_25829);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__25797 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__25798 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__25798);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__25797);
}})], null);
}));
