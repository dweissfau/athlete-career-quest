...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_10258 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_10258(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_10264 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_10264(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_10275 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_10275(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_10286 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_10286(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_10320 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_10320(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_10325 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_10325(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__10219,callback){
var map__10222 = p__10219;
var map__10222__$1 = cljs.core.__destructure_map(map__10222);
var input = map__10222__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10222__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10222__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
